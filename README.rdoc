...
(That is an Regional RubyKaigi instance, http://regional.rubykaigi.org/tokyo01)
...
2. $ ruby timekeepersrv
   (If you don't have ruby, you can write similar http proxy.)
3. http://localhost:8111 via some web browser.
  (8111 is default and configurable.)
